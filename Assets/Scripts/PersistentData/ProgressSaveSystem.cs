...
public static class ProgressSaveSystem
{
    ...
    public static void Save(ProgressSaveData data)
    {
        if (data == null)
        {
            Debug.LogError("[Save] Se intent� guardar data null.");
            return;
        }
    ...
    public static ProgressSaveData Load()
    {
        ...
        {
            Debug.LogWarning("[Save] JSON vac�o o corrupto. Recreando save.");
            ProgressSaveData defaultData = CreateDefaultData();
            Save(defaultData);
            return defaultData;
        }
        ...
        if (data == null)
        {
            Debug.LogWarning("[Save] JSON inv�lido. Recreando save.");
            ProgressSaveData defaultData = CreateDefaultData();
            Save(defaultData);
            return defaultData;
        }
    ...
    public static bool CopyCurrentSaveToFolder(string saveFileName)
    {
        ...
        {
            Debug.LogWarning("[Save] El nombre de la partida est� vac�o.");
            return false;
        }
        ...
        if (string.IsNullOrWhiteSpace(saveFileName))
        {
            Debug.LogWarning("[Save] El nombre de la partida no es v�lido.");
            return false;
        }
    ...
    public static bool LoadSaveFileAsCurrent(string sourceFilePath)
    {
        ...
        {
            Debug.LogWarning("[Save] Ruta de archivo vac�a.");
            return false;
        }
    ...
    public static bool DeleteSaveFile(string filePath)
    {
        ...
        {
            Debug.LogWarning("[Save] Ruta de borrado vac�a.");
            return false;
        }
